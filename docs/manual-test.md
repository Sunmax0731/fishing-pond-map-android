...
`D:\AI\AndroidApp\fishing-pond-map-android`
...
- `public/index.html`
- `dist/fishing-pond-map-android-docs.zip`

## セットアップ手順

```powershell
cd D:\AI\AndroidApp\fishing-pond-map-android
npm test
npm start
```
...
4. `dist/fishing-pond-map-android-docs.zip` を展開し、README、導入手順、ユーザーガイド、QCDS、release evidence が含まれることを確認する。
